...
class ProjectOrganizerUITests: XCTestCase {
    ...
    func testOpenTabAddsItems() {
        ...
        XCTAssertEqual(app.tables.cells.count, 0, "There should be no listrows initially")
    ...
    func testingEditingProjectUpdatesCorrectly() {
        ...
        XCTAssertTrue(app.buttons["NEW PROJECT 2"].exists, "The new projecet anme should be visible in the list")
    }
